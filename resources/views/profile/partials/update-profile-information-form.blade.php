<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Update your account's profile information, occupation, and avatar.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div>
            ...
            @if($user->avatar)
                <img src="{{ asset('storage/' . $user->avatar) }}" class="h-16 w-16 rounded-full object-cover mb-2 border">
            @endif
